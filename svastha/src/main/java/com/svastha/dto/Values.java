...
public class Values {
	...
	public int getCloudBaseMin() {
		return cloudBaseMin;
	}

	public void setCloudBaseMin(int cloudBaseMin) {
	...
	public int getCloudCeilingMin() {
		return cloudCeilingMin;
	}

	public void setCloudCeilingMin(int cloudCeilingMin) {
	...
	public void setCloudCoverAvg(double cloudCoverAvg) {
		this.cloudCoverAvg = cloudCoverAvg;
	}

	public double getCloudCoverMax() {
		return cloudCoverMax;
	}

	public void setCloudCoverMax(double cloudCoverMax) {
		this.cloudCoverMax = cloudCoverMax;
	}

	public double getCloudCoverMin() {
		return cloudCoverMin;
	}

	public void setCloudCoverMin(double cloudCoverMin) {
	...
	public int getFreezingRainIntensityAvg() {
		return freezingRainIntensityAvg;
	}

	public void setFreezingRainIntensityAvg(int freezingRainIntensityAvg) {
		this.freezingRainIntensityAvg = freezingRainIntensityAvg;
	}

	public int getFreezingRainIntensityMax() {
		return freezingRainIntensityMax;
	}

	public void setFreezingRainIntensityMax(int freezingRainIntensityMax) {
		this.freezingRainIntensityMax = freezingRainIntensityMax;
	}

	public int getFreezingRainIntensityMin() {
		return freezingRainIntensityMin;
	}

	public void setFreezingRainIntensityMin(int freezingRainIntensityMin) {
	...
	public int getIceAccumulationAvg() {
		return iceAccumulationAvg;
	}

	public void setIceAccumulationAvg(int iceAccumulationAvg) {
		this.iceAccumulationAvg = iceAccumulationAvg;
	}

	public int getIceAccumulationLweAvg() {
		return iceAccumulationLweAvg;
	}

	public void setIceAccumulationLweAvg(int iceAccumulationLweAvg) {
		this.iceAccumulationLweAvg = iceAccumulationLweAvg;
	}

	public int getIceAccumulationLweMax() {
		return iceAccumulationLweMax;
	}

	public void setIceAccumulationLweMax(int iceAccumulationLweMax) {
		this.iceAccumulationLweMax = iceAccumulationLweMax;
	}

	public int getIceAccumulationLweMin() {
		return iceAccumulationLweMin;
	}

	public void setIceAccumulationLweMin(int iceAccumulationLweMin) {
		this.iceAccumulationLweMin = iceAccumulationLweMin;
	}

	public int getIceAccumulationLweSum() {
		return iceAccumulationLweSum;
	}

	public void setIceAccumulationLweSum(int iceAccumulationLweSum) {
		this.iceAccumulationLweSum = iceAccumulationLweSum;
	}

	public int getIceAccumulationMax() {
		return iceAccumulationMax;
	}

	public void setIceAccumulationMax(int iceAccumulationMax) {
		this.iceAccumulationMax = iceAccumulationMax;
	}

	public int getIceAccumulationMin() {
		return iceAccumulationMin;
	}

	public void setIceAccumulationMin(int iceAccumulationMin) {
		this.iceAccumulationMin = iceAccumulationMin;
	}

	public int getIceAccumulationSum() {
		return iceAccumulationSum;
	}

	public void setIceAccumulationSum(int iceAccumulationSum) {
	...
	public void setPrecipitationProbabilityAvg(double precipitationProbabilityAvg) {
	...
	public int getPrecipitationProbabilityMin() {
		return precipitationProbabilityMin;
	}

	public void setPrecipitationProbabilityMin(int precipitationProbabilityMin) {
	...
	public int getRainAccumulationAvg() {
		return rainAccumulationAvg;
	}

	public void setRainAccumulationAvg(int rainAccumulationAvg) {
	...
	public int getRainAccumulationLweMin() {
		return rainAccumulationLweMin;
	}

	public void setRainAccumulationLweMin(int rainAccumulationLweMin) {
		this.rainAccumulationLweMin = rainAccumulationLweMin;
	}

	public int getRainAccumulationMax() {
		return rainAccumulationMax;
	}

	public void setRainAccumulationMax(int rainAccumulationMax) {
		this.rainAccumulationMax = rainAccumulationMax;
	}

	public int getRainAccumulationMin() {
		return rainAccumulationMin;
	}

	public void setRainAccumulationMin(int rainAccumulationMin) {
		this.rainAccumulationMin = rainAccumulationMin;
	}

	public int getRainAccumulationSum() {
		return rainAccumulationSum;
	}

	public void setRainAccumulationSum(int rainAccumulationSum) {
	...
	public int getRainIntensityMin() {
		return rainIntensityMin;
	}

	public void setRainIntensityMin(int rainIntensityMin) {
		this.rainIntensityMin = rainIntensityMin;
	}

	public int getSleetAccumulationAvg() {
		return sleetAccumulationAvg;
	}

	public void setSleetAccumulationAvg(int sleetAccumulationAvg) {
		this.sleetAccumulationAvg = sleetAccumulationAvg;
	}

	public int getSleetAccumulationLweAvg() {
		return sleetAccumulationLweAvg;
	}

	public void setSleetAccumulationLweAvg(int sleetAccumulationLweAvg) {
		this.sleetAccumulationLweAvg = sleetAccumulationLweAvg;
	}

	public int getSleetAccumulationLweMax() {
		return sleetAccumulationLweMax;
	}

	public void setSleetAccumulationLweMax(int sleetAccumulationLweMax) {
		this.sleetAccumulationLweMax = sleetAccumulationLweMax;
	}

	public int getSleetAccumulationLweMin() {
		return sleetAccumulationLweMin;
	}

	public void setSleetAccumulationLweMin(int sleetAccumulationLweMin) {
		this.sleetAccumulationLweMin = sleetAccumulationLweMin;
	}

	public int getSleetAccumulationLweSum() {
		return sleetAccumulationLweSum;
	}

	public void setSleetAccumulationLweSum(int sleetAccumulationLweSum) {
		this.sleetAccumulationLweSum = sleetAccumulationLweSum;
	}

	public int getSleetAccumulationMax() {
		return sleetAccumulationMax;
	}

	public void setSleetAccumulationMax(int sleetAccumulationMax) {
		this.sleetAccumulationMax = sleetAccumulationMax;
	}

	public int getSleetAccumulationMin() {
		return sleetAccumulationMin;
	}

	public void setSleetAccumulationMin(int sleetAccumulationMin) {
		this.sleetAccumulationMin = sleetAccumulationMin;
	}

	public int getSleetIntensityAvg() {
		return sleetIntensityAvg;
	}

	public void setSleetIntensityAvg(int sleetIntensityAvg) {
		this.sleetIntensityAvg = sleetIntensityAvg;
	}

	public int getSleetIntensityMax() {
		return sleetIntensityMax;
	}

	public void setSleetIntensityMax(int sleetIntensityMax) {
		this.sleetIntensityMax = sleetIntensityMax;
	}

	public int getSleetIntensityMin() {
		return sleetIntensityMin;
	}

	public void setSleetIntensityMin(int sleetIntensityMin) {
		this.sleetIntensityMin = sleetIntensityMin;
	}

	public int getSnowAccumulationAvg() {
		return snowAccumulationAvg;
	}

	public void setSnowAccumulationAvg(int snowAccumulationAvg) {
		this.snowAccumulationAvg = snowAccumulationAvg;
	}

	public int getSnowAccumulationLweAvg() {
		return snowAccumulationLweAvg;
	}

	public void setSnowAccumulationLweAvg(int snowAccumulationLweAvg) {
		this.snowAccumulationLweAvg = snowAccumulationLweAvg;
	}

	public int getSnowAccumulationLweMax() {
		return snowAccumulationLweMax;
	}

	public void setSnowAccumulationLweMax(int snowAccumulationLweMax) {
		this.snowAccumulationLweMax = snowAccumulationLweMax;
	}

	public int getSnowAccumulationLweMin() {
		return snowAccumulationLweMin;
	}

	public void setSnowAccumulationLweMin(int snowAccumulationLweMin) {
		this.snowAccumulationLweMin = snowAccumulationLweMin;
	}

	public int getSnowAccumulationLweSum() {
		return snowAccumulationLweSum;
	}

	public void setSnowAccumulationLweSum(int snowAccumulationLweSum) {
		this.snowAccumulationLweSum = snowAccumulationLweSum;
	}

	public int getSnowAccumulationMax() {
		return snowAccumulationMax;
	}

	public void setSnowAccumulationMax(int snowAccumulationMax) {
		this.snowAccumulationMax = snowAccumulationMax;
	}

	public int getSnowAccumulationMin() {
		return snowAccumulationMin;
	}

	public void setSnowAccumulationMin(int snowAccumulationMin) {
		this.snowAccumulationMin = snowAccumulationMin;
	}

	public int getSnowAccumulationSum() {
		return snowAccumulationSum;
	}

	public void setSnowAccumulationSum(int snowAccumulationSum) {
	...
	public void setSnowIntensityAvg(int snowIntensityAvg) {
		this.snowIntensityAvg = snowIntensityAvg;
	}

	public int getSnowIntensityMax() {
		return snowIntensityMax;
	}

	public void setSnowIntensityMax(int snowIntensityMax) {
		this.snowIntensityMax = snowIntensityMax;
	}

	public int getSnowIntensityMin() {
		return snowIntensityMin;
	}

	public void setSnowIntensityMin(int snowIntensityMin) {
	...
	public int getUvHealthConcernAvg() {
		return uvHealthConcernAvg;
	}

	public void setUvHealthConcernAvg(int uvHealthConcernAvg) {
		this.uvHealthConcernAvg = uvHealthConcernAvg;
	}

	public int getUvHealthConcernMax() {
		return uvHealthConcernMax;
	}

	public void setUvHealthConcernMax(int uvHealthConcernMax) {
		this.uvHealthConcernMax = uvHealthConcernMax;
	}

	public int getUvHealthConcernMin() {
		return uvHealthConcernMin;
	}

	public void setUvHealthConcernMin(int uvHealthConcernMin) {
	...
	public void setUvIndexAvg(int uvIndexAvg) {
		this.uvIndexAvg = uvIndexAvg;
	}

	public int getUvIndexMax() {
		return uvIndexMax;
	}

	public void setUvIndexMax(int uvIndexMax) {
		this.uvIndexMax = uvIndexMax;
	}

	public int getUvIndexMin() {
		return uvIndexMin;
	}

	public void setUvIndexMin(int uvIndexMin) {
	...
	public void setVisibilityAvg(double visibilityAvg) {
		this.visibilityAvg = visibilityAvg;
	}

	public double getVisibilityMax() {
		return visibilityMax;
	}

	public void setVisibilityMax(double visibilityMax) {
		this.visibilityMax = visibilityMax;
	}

	public double getVisibilityMin() {
		return visibilityMin;
	}

	public void setVisibilityMin(double visibilityMin) {
		this.visibilityMin = visibilityMin;
	}

	public int getWeatherCodeMax() {
		return weatherCodeMax;
	}

	public void setWeatherCodeMax(int weatherCodeMax) {
		this.weatherCodeMax = weatherCodeMax;
	}

	public int getWeatherCodeMin() {
		return weatherCodeMin;
	}

	public void setWeatherCodeMin(int weatherCodeMin) {
	...
	private int snowAccumulationAvg;
	...
	private int snowAccumulationMax;
	private int snowAccumulationMin;
	private int snowAccumulationSum;
