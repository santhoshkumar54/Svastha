...
@Entity
public class ProjectSyntheticFertilizers {
	...
	@ManyToOne
	private MasterFertilizers fertilizer;
	...
	public MasterFertilizers getFertilizer() {
		return fertilizer;
	}

	public void setFertilizer(MasterFertilizers fertilizer) {
