...
public class OrganicExcelWriter {
			...
			for (FarmProjects project : projects) {
				...
				for (ProjectPlots plot : plots) {
					...
					if (plotRow.getCell(19) == null) {
						...
						plotRow.createCell(21).setCellValue(farmPlot.getLocation() == null ? "No" : "Yes");
					}
					int start = rowNum;
					int end = rowNum;
	...
	private void generateAnnualCrop(FarmProjects project, FarmPlots farmPlot, Row row) {
		...
		if (obj != null) {
			row.createCell(22).setCellValue(obj.getAnnualProgram().getName());
			row.createCell(23).setCellValue(obj.getArea());
			row.createCell(24).setCellValue(obj.getCrop().getCrop());
		}
	}
	...
	private void generateVariety(FarmProjects project, FarmPlots farmPlot, Row row) {
		...
		if (obj != null) {
			row.createCell(25).setCellValue(obj.getCropVariety().getVariety());
		}
	}
		...
		if (objs != null) {
			for (OrganicPlotBoundary obj : objs) {
				if (obj.getDirections().equals("North")) {
					row.createCell(26).setCellValue(obj.getDirections());
					row.createCell(27).setCellValue(obj.getFarmerName());
					row.createCell(28).setCellValue(obj.getPractice());
					row.createCell(29).setCellValue(obj.getArea());
					row.createCell(30).setCellValue(obj.getRisk().getName());
				} else if (obj.getDirections().equals("East")) {
					row.createCell(31).setCellValue(obj.getDirections());
					row.createCell(32).setCellValue(obj.getFarmerName());
					row.createCell(33).setCellValue(obj.getPractice());
					row.createCell(34).setCellValue(obj.getArea());
					row.createCell(35).setCellValue(obj.getRisk().getName());
				} else if (obj.getDirections().equals("South")) {
					row.createCell(36).setCellValue(obj.getDirections());
					row.createCell(37).setCellValue(obj.getFarmerName());
					row.createCell(38).setCellValue(obj.getPractice());
					row.createCell(39).setCellValue(obj.getArea());
					row.createCell(40).setCellValue(obj.getRisk().getName());
				} else if (obj.getDirections().equals("West")) {
					row.createCell(41).setCellValue(obj.getDirections());
					row.createCell(42).setCellValue(obj.getFarmerName());
					row.createCell(43).setCellValue(obj.getPractice());
					row.createCell(44).setCellValue(obj.getArea());
					row.createCell(45).setCellValue(obj.getRisk().getName());
				}
			}
		}
	}
	...
	private void generateWater(FarmProjects project, FarmPlots farmPlot, Row row) {
		...
		if (obj != null) {
			row.createCell(46).setCellValue(obj.getAlkalinity());
			row.createCell(47).setCellValue(obj.getPh());
			row.createCell(48).setCellValue(obj.getBicarbonates());
			row.createCell(49).setCellValue(obj.getDissolvedCalcium());
			row.createCell(50).setCellValue(obj.getCarbonates());
			row.createCell(51).setCellValue(obj.getRiversideClassification());
			row.createCell(52).setCellValue(obj.getChloride());
			row.createCell(53).setCellValue(obj.getConductivity());
			row.createCell(54).setCellValue(obj.getHardness());
			row.createCell(55).setCellValue(obj.getPhosphate());
		}
	}
	...
	private void generateSoil(FarmProjects project, FarmPlots farmPlot, Row row) {
		...
		if (obj != null) {
			row.createCell(56).setCellValue(obj.getSoiltype().getName());
			row.createCell(57).setCellValue(obj.getSoilEc());
			row.createCell(58).setCellValue(obj.getSoilPh());
			row.createCell(59).setCellValue(obj.getNitrogen());
			row.createCell(60).setCellValue(obj.getPhosporus());
			row.createCell(61).setCellValue(obj.getPotassium());
			row.createCell(62).setCellValue(obj.getSulphur());
			row.createCell(63).setCellValue(obj.getZinc());
			row.createCell(64).setCellValue(obj.getBoron());
			row.createCell(65).setCellValue(obj.getIron());
			row.createCell(66).setCellValue(obj.getManganese());
			row.createCell(67).setCellValue(obj.getCopper());
			row.createCell(68).setCellValue(obj.getOrganic_copper());
		}
	}
	...
	private void generateSeedData(FarmProjects project, FarmPlots farmPlot, Row row) {
		...
		if (obj != null) {
			row.createCell(69).setCellValue(obj.getSeedRate());
			row.createCell(70).setCellValue(obj.getSource());
		}
	}
	...
	private void generateSowing(FarmProjects project, FarmPlots farmPlot, Row row) {
		...
		if (obj != null) {
			row.createCell(71).setCellValue(obj.getSowingDate());
		}
	}
	...
	private void generateTransplantData(FarmProjects project, FarmPlots farmPlot, Row row) {
		...
		if (obj != null) {
			row.createCell(72).setCellValue(obj.getTransplantDate());
		}
	}
	...
	private int generateFertilizer(FarmProjects project, FarmPlots farmPlot, int start, int end, int rowNum,
		...
		for (OrganicBioFertilizer obj : objs) {
			...
			if (row.getCell(19) == null) {
				...
				row.createCell(21).setCellValue(obj.getPlots().getLocation() == null ? "No" : "Yes");
			}
			row.createCell(73).setCellValue(obj.getBioFertilizer() == null ? "" : obj.getBioFertilizer().getName());
			row.createCell(74).setCellValue(obj.getDose());
			row.createCell(75).setCellValue(obj.getUsedDate());
			row.createCell(76).setCellValue(obj.getSource());
	...
	private int generateOrganicManure(FarmProjects project, FarmPlots farmPlot, int start, int end, int rowNum,
		...
		for (OrganicOrganicManure obj : objs) {
			...
			row.createCell(77).setCellValue(obj.getManure() == null ? "" : obj.getManure().getName());
			row.createCell(78).setCellValue(obj.getDose());
			row.createCell(79).setCellValue(obj.getUsedDate());
			row.createCell(80).setCellValue(obj.getSource());
	...
	private int generateGrowth(FarmProjects project, FarmPlots farmPlot, int start, int end, int rowNum, Sheet sheet) {
		...
		for (OrganicGrowthPromoter obj : objs) {
			...
			row.createCell(81).setCellValue(obj.getGrowthPromoter() == null ? "" : obj.getGrowthPromoter().getName());
			row.createCell(82).setCellValue(obj.getDose());
			row.createCell(83).setCellValue(obj.getUsedDate());
			row.createCell(84).setCellValue(obj.getSource());
	...
	private int generatPests(FarmProjects project, FarmPlots farmPlot, int start, int end, int rowNum, Sheet sheet) {
		...
		for (OrganicProtection obj : objs) {
			...
			row.createCell(85).setCellValue(obj.getPests() == null ? "" : obj.getPests().getName());
			row.createCell(86).setCellValue(obj.getGrowth() == null ? "" : obj.getGrowth().getName());
			row.createCell(87).setCellValue(obj.getAppliedDose());
			row.createCell(88).setCellValue(obj.getAppliedDate());
			row.createCell(89).setCellValue(obj.getAppliedMethod());
			row.createCell(90).setCellValue(obj.getAppliedMode());
			row.createCell(91).setCellValue(obj.getStage().getCropStage());
			row.createCell(92).setCellValue(obj.getCompliant());
	...
	private void generateHarvestData(FarmProjects project, FarmPlots farmPlot, Row row) {
		...
		if (obj != null) {
			row.createCell(94).setCellValue(obj.getHarvestDate());
			row.createCell(95).setCellValue(obj.getHarvestYield());
		}
	}
